...
// Construct C
//do1.p = 1;
c[0] = Z3_mk_eq(ctx, id1, one);
c[1] = Z3_mk_eq(ctx, loc1, mem_1); // creating memory position

//do1.s = 5;
c[2] = Z3_mk_eq(ctx, s1, size_five);
